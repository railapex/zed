...
pub struct Editor {
    ...
    read_only_diff_buffer_ids: HashSet<BufferId>,
    display_diff_generations: HashMap<BufferId, u64>,
    next_display_diff_generation: u64,
...
impl Editor {
    ...
    fn new_internal(
        ...
        let mut editor = Self {
            ...
            read_only_diff_buffer_ids: HashSet::default(),
            display_diff_generations: HashMap::default(),
            next_display_diff_generation: 0,
            minimap: None,
